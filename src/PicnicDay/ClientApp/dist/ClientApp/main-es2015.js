...
let ResultComponent = class ResultComponent {
    ...
    ngOnChanges(changes) {
        const airportid = changes.airportid;
...
let SearchComponent = class SearchComponent {
    ...
    ngOnInit() {
        ...
        this.filteredAirports = this.control.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(value => this._filter(value)));
        this.searchResult;
    }
    _filter(value) {
